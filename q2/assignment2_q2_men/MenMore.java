...
public class MenMore
{
	...
	public class Shirt
	{
		String item_name[] = {"shirt1","shirt2","shirt3","shirt4","shirt5","shirt6"};
	...
	{
		String item_name[] = {"perfume1","perfume2","perfume3"};
		String item_id[] = {"P01","P02","P03"};
		String item_size[] = {"S","M","L"};
		String item_color[] = {"black","white","black"};
		...
		public class Watch
		{
			String item_name[] = {"watch1","watch2","watch3","watch4","watch5","watch6","watch7","watch8"};
			String item_id[] = {"W01","W02","W03","W04","W05","W06","W07","W08"};
			String item_size[] = {"S","M","L","XL","M","L","M","XL"};
			String item_color[] = {"black","white","black","grey","white","black","black","grey"};
