...
import assignment2_q2_women.WomenMore.Shirt;

public class Women extends WomenMore
{
	
	String womenCategories[] = {"Clothing","Accessories"};
	
	public int getTotalItems_inWomen()
	{
	...
	public void showWomenCategories()
	{
		System.out.println("These are the following sub Categories in Women.");
		for(int i=0;i<womenCategories.length;i++)
		{
			System.out.println(womenCategories[i]);
		}
